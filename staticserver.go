...
const (
	Template_Dir = "./view/"
	Upload_Dir   = "/Users/zhangmin/server/fileServer/upload/"
)
...
func upload(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "GET" {
		...
		fmt.Println("filename:="+Upload_Dir+filename)

		f, _ := os.OpenFile(Upload_Dir+filename, os.O_CREATE|os.O_WRONLY, 0644)
